...
abstract class SalesAnalytics
  ...
  Map<String, dynamic> toJsonForProtocol() {
    return {
      ...
      'averageOrderValue': averageOrderValue,
      'numberOfOrders': numberOfOrders,
      'salesData': salesData.toJson(valueToJson: (v) => v.toJsonForProtocol()),
      'topProducts':
          topProducts.toJson(valueToJson: (v) => v.toJsonForProtocol()),
      'salesTrend':
          salesTrend.toJson(valueToJson: (v) => v.toJsonForProtocol()),
      'paymentMethodBreakdown': paymentMethodBreakdown.toJson(),
    };
  }
